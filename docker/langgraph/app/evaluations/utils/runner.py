...
async def run_scenario_langraph(item, simulate=False, graph=None, config=None):
    user_input = item.input
    output = item.expected_output
    expected_tools = [ToolCall(name=tc["name"], args=tc.get("args", {})) for tc in output["expected_tools"]]
